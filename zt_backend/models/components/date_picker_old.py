...
# def validate_iso_date_format(date_str: str) -> str:
#     try:
#         isoparse(date_str)
#         return date_str
#     except ParserError:
#         raise ValueError("value must be in a valid ISO format")
'''
...
class DatePicker(ZTComponent):
    ...
    # type: Literal['date'] = Field('date', description="Type of the value in date picker")  # Non-editable field
    ...
    # month: Union[int, str] = Field(current_month, description="The current month number to show in the Date picker view")#change
